...
- Taratura dei parametri di `fanta/config/scambi.json` (rumore, margine, soglia, tetto, scarsità di ruolo, `proponiOgniGiornate`): valori di partenza plausibili, non ancora provati su una stagione giocata da persone vere
